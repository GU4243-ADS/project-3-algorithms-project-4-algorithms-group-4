...
# rankscore <- rank_scoring(pred_ms, MS_UI_test, 5)

# load("../data/web.sp.p.Rdata")
# load("../data/web.etp.p.Rdata")
# load("../data/web.msd.p.Rdata")
# 
web_spearman <- readRDS("/Users/yunli/Documents/GitHub/project-3-algorithms-project-4-algorithms-group-4/web_spearman.RData")
rank_scoring(web_spearman, MS_UI_test, 10)
