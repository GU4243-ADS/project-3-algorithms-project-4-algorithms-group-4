...
EM_func <= function(data, C = 1, tau = 0.01, iter = 100){ 
  # function arguments include:
      ...
      #tau: threshold for termination when values converge, using tau = 0.05 from previous year's code 
      #iter: maximum number of iterations
 # function output = ???
  
  # terminate when if iter = 10000 or if $\sum{c = 1}^C \abs{\hat{\mu_c^{t+1}} - \hat{\mu_c^{t}}}^2$ where |x| is the l-2 norm. 
