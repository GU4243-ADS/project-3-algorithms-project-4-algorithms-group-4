...
(mse <- sum((pred_movie_pearson[what.to.predict] - movie_UI_test[what.to.predict])**2)/length(what.to.predict))
(mae <- sum(abs(pred_movie_pearson[what.to.predict] - movie_UI_test[what.to.predict]))/length(what.to.predict))

R2.numer <- 1 - sum((pred_movie_pearson[what.to.predict] - movie_UI_test[what.to.predict])**2)
R2.denom <- sum((movie_UI_test[what.to.predict] - mean(movie_UI_test[what.to.predict]))**2)
